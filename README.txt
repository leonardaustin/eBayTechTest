...
## Improvements
 ...
 - HTML: Remove inline styles and move to stylesheet, change title for each page and meta description. Possibly add ajax to improve UI and maybe added images. Navigation set as list items rather than inline with a pipe separator. 
